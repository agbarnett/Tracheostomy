...
## Summary statistics and plots for drugs
...
```{r boxplot.drugs}
to.plot = select(data, 'id', 'analgesics_ETT', 'analgesics_trache', 'sedatives_ETT', 'sedatives_trache','antipsychotics_ETT','antipsychotics_trache',"24hrs_drug_free_ETT" ,"24hrs_drug_free_trache") %>%
...
Here we examine what types of patients received a tracheostomy. We examine whether variables such as younger age were associated with shorter times to tracheostomy. We model the days between the ventilation starting and the tracheostomy. Patients who died first were censored. The table shows the hazard ratio from a Cox survival model, together with a 95% confidence interval and p-value.
...
## Model of the risk of death in ICU after tracheostomy

```{r model.icu.death}
e = extra.time(indata = data, outcome = 'ICUdeathDate', n.boot=100)
```
